...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Frame = __webpack_require__(167);
	...
	var Main = _react2.default.createClass({
		...
		handleLeft: function handleLeft(evt) {
			evt.preventDefault();
			evt.stopPropagation();
		...
		handleRight: function handleRight(evt) {
			evt.preventDefault();
			evt.stopPropagation();
			var arrow = evt.target;
			if (arrow.classList.contains('size')) {
		...
		changeStyle: function changeStyle(n) {
			var newStyle = 0;
		...
		changeSkin: function changeSkin(n) {
		...
		changeShape: function changeShape(n) {
		...
		changeEyes: function changeEyes(n) {
		...
		changeBrows: function changeBrows(n) {
		...
		changeIris: function changeIris(n) {
		...
		changeNose: function changeNose(n) {
		...
		changeMouth: function changeMouth(n) {
		...
		changeColor: function changeColor(n) {
		...
		changeHairstyle: function changeHairstyle(n) {
		...
		changeBangs: function changeBangs(n) {
		...
		changeFacial: function changeFacial(n) {
		...
		changeTop: function changeTop(n) {
		...
		changeBottoms: function changeBottoms(n) {
	 ...
	 */
		...
		handleConnect: function handleConnect(evt) {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'renderApp' },
				_react2.default.createElement(_Header2.default, { load: this.handleLoad, anim: this.playAnimation, reset: this.handleReset, save: this.handleSave, connect: this.handleConnect }),
				_react2.default.createElement(_Container2.default, { leftArrow: this.handleLeft, rightArrow: this.handleRight, style: avatarStyle, size: avatarSize, skin: avatarSkin, shape: avatarShape, eyes: avatarEyes, brows: avatarBrows, irises: avatarIrises, nose: avatarNose, mouth: avatarMouth, color: avatarColor, hairstyle: avatarHairstyle, bangs: avatarBangs, facial: avatarFacial, top: avatarTop, bottoms: avatarBottoms }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoryBox = __webpack_require__(161);

	var _CategoryBox2 = _interopRequireDefault(_CategoryBox);

	var _AvatarBox = __webpack_require__(164);
	...
	var Container = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_CategoryBox2.default, { leftArrow: this.props.leftArrow, rightArrow: this.props.rightArrow }),
				_react2.default.createElement(_AvatarBox2.default, { style: this.props.style, size: this.props.size, skin: this.props.skin, shape: this.props.shape, eyes: this.props.eyes, brows: this.props.brows, irises: this.props.irises, nose: this.props.nose, mouth: this.props.mouth, color: this.props.color, hairstyle: this.props.hairstyle, bangs: this.props.bangs, facial: this.props.facial, top: this.props.top, bottoms: this.props.bottoms })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoryControls = __webpack_require__(162);

	var _CategoryControls2 = _interopRequireDefault(_CategoryControls);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var CategoryBox = _react2.default.createClass({
		...
		categoryToggle: function categoryToggle(evt) {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_CategoryControls2.default, { categoryTitle: 'Body', leftArrow: this.props.leftArrow, rightArrow: this.props.rightArrow, categoryToggle: this.categoryToggle, activeControl: active, options: ["style", "size", "skin"] }),
				_react2.default.createElement(_CategoryControls2.default, { categoryTitle: 'Face', leftArrow: this.props.leftArrow, rightArrow: this.props.rightArrow, categoryToggle: this.categoryToggle, activeControl: active, options: ["shape", "eyes", "brows", "irises", "nose", "mouth"] }),
				_react2.default.createElement(_CategoryControls2.default, { categoryTitle: 'Hair', leftArrow: this.props.leftArrow, rightArrow: this.props.rightArrow, categoryToggle: this.categoryToggle, activeControl: active, options: ["color", "hairstyle", "bangs", "facial"] }),
				_react2.default.createElement(_CategoryControls2.default, { categoryTitle: 'Clothing', leftArrow: this.props.leftArrow, rightArrow: this.props.rightArrow, categoryToggle: this.categoryToggle, activeControl: active, options: ["top", "bottoms", "shoes", "professional"] })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryControls = _react2.default.createClass({
		displayName: 'CategoryControls',
		...
		makeOptions: function makeOptions() {
			...
			if (this.state.optionsList.length) {
				for (var i = 0; i < this.state.optionsList.length; i++) {
					...
					optionsEls.push(_react2.default.createElement(_Option2.default, { index: i, key: key, optionTitle: this.state.optionsList[i], bodyPart: this.props.categoryTitle, rightArrow: this.props.rightArrow, leftArrow: this.props.leftArrow }));
				}
			}
			return optionsEls;
		},
		render: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: controlClasses, onClick: this.props.categoryToggle },
	...
	exports.default = CategoryControls;
	...
	var Option = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				"div",
				{ className: classes },
				_react2.default.createElement("div", { className: leftClasses, onClick: this.props.leftArrow }),
				_react2.default.createElement(
					"h5",
					{ className: "optionTitle" },
					this.props.optionTitle
				),
				_react2.default.createElement("div", { className: rightClasses, onClick: this.props.rightArrow })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SVG = __webpack_require__(165);

	var _SVG2 = _interopRequireDefault(_SVG);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var AvatarBox = _react2.default.createClass({
		displayName: 'AvatarBox',
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'avatarBox' },
				_react2.default.createElement(_SVG2.default, { size: this.props.size, skin: this.props.skin, shape: this.props.shape, hairstyle: this.props.hairstyle, color: this.props.color, bangs: this.props.bangs, eyes: this.props.eyes, brows: this.props.brows, irises: this.props.irises, nose: this.props.nose, mouth: this.props.mouth })
			);
		}
	});

	exports.default = AvatarBox;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SVG = _react2.default.createClass({
		...
		getBodyPath: function getBodyPath() {
		...
		getSkinColor: function getSkinColor() {
		...
		getFacePath: function getFacePath() {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"svg",
					{ version: "1.1", x: "0px", y: "0px", width: "220px", height: "620px", viewBox: "0 0 220 620", "enable-background": "new 0 0 220 620" },
					hairPath,
					_react2.default.createElement("path", { fill: skinColor, stroke: skinColor, strokeWidth: "1", "stroke-miterlimit": "10", d: bodyPath }),
					_react2.default.createElement("path", { fill: skinColor, stroke: skinColor, strokeWidth: "1", "stroke-miterlimit": "10", d: facePath }),
					eyes,
					browsPath,
					bangs,
					_react2.default.createElement("path", { fill: "none", stroke: "#231F20", strokeWidth: "1", "stroke-miterlimit": "10", d: nosePath }),
					mouthPath,
					irisPaths
				)
			);
	...
	var Header = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"div",
					{ className: "headerOptionGroup" },
					_react2.default.createElement(
						"div",
						{ className: "headerOption save" },
						_react2.default.createElement("input", { type: "button", className: "headerBtn", id: "connect-calendar", value: "connect", onClick: this.props.connect })
					),
					_react2.default.createElement(
						"div",
						{ className: "headerOption misc" },
						_react2.default.createElement("input", { type: "button", className: "headerBtn", id: "animate-avatar", value: "conquer", onClick: this.props.anim })
					),
					_react2.default.createElement(
						"div",
						{ className: "headerOption reset" },
						_react2.default.createElement("input", { type: "button", className: "headerBtn", id: "reset-avatar", value: "reset", onClick: this.props.reset })
					),
					_react2.default.createElement(
						"div",
						{ className: "headerOption done" },
						_react2.default.createElement("input", { type: "button", className: "headerBtn", id: "load-avatar", value: "load", onClick: this.props.load })
					),
					_react2.default.createElement(
						"div",
						{ className: "headerOption done" },
						_react2.default.createElement("input", { type: "button", className: "headerBtn", id: "save-progress", value: "save", onClick: this.props.save })
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Frame = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				"div",
				{ className: "connectFrame", id: "authorize-div" },
				_react2.default.createElement("iframe", { src: "connect.html", width: "400", height: "300" })
			);
		}
	});
